...
In pgAdmin 4, create a table called "time_series_data"
Right click on the table and import the CSV file "InSAR_Data.csv"
Make sure Header is enabled, Delimiter is ",", Quote and Escape are blank
Right click on Columns under "time_series_data" table and click PSQL Tool
Now we will add the columns under "Query" with the code below:
...
Now you should be able to run the code to create the columns.
